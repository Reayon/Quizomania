    ...
    <header style="height: 100px">
        ...
        <div class="menu">
            ...
            <h2>KREATOR KATEGORII</h2>
                ...
                <div class="srodek">
                    <p>Stwórz nazwę kategorii twojego quizu.</p>
                    <p>Podaj nazwę i kliknij przycisk "Zatwierdź kategorie",
                    następnie "Wroć do edytora" wyszukaj swoją kategorie na liście dostępnych z edytuj dodając pytania i odpowiedzi.</p>
                <table class="tabela">
                    <thead>
                        <tr>
                            <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
                                <h4>Wpisz nazwę swojej kategorii: <input type="text" name="fname"></h4><br>
                                <p><input type="submit" value="Zatwierdź kategorie"></p><br>
                            </form>
                        </tr>
                    </thead>
                    <tbody>
                    <?php
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                            ...
                            $name = $_POST['fname'];
                            if (empty($name)) {
                              echo "<p style=color:red>Nazwa jest pusta</p>";
                            } else {
                                echo "<tr>";
                                echo "<p style=color:green>Dodano kategorie!</p>";
                                echo "<p>Twoja dodana kategoria to: ". $name."</p>";
                                echo "</tr>";
